    ...
    function getDefaultPageModules(page) {
        ...
        if (page === 'industries') {
            return [
                pageHero('industries-hero', 'Hero / Industries intro', 'Industries', 'Automation Solutions Designed Around Real Operational Challenges.', 'Explore how manufacturers, warehouses, and logistics operators improve storage capacity, production efficiency, material flow, and operational performance through practical automation technologies.'),
                {
                    ...
                    text: '',
                    items: [
                        cardItem('industries-proof-1', '10+ Industries', '', 'case-studies.html#caseGrid'),
                        cardItem('industries-proof-2', '100+ Project References', '', 'case-studies.html#caseGrid'),
                        cardItem('industries-proof-3', 'Warehouse Automation', '', 'case-studies.html?solution=asrs#caseGrid'),
                        cardItem('industries-proof-4', 'Smart Factory Solutions', '', 'case-studies.html?solution=smart-factory#caseGrid'),
                        cardItem('industries-proof-5', 'Industrial Manufacturing Systems', '', 'case-studies.html?industry=manufacturing-industrial#caseGrid'),
                    ],
                },
                {
                    id: 'industries-list',
                    ...
                    text: '',
                    items: [
                        cardItem('industry-chemical', 'Chemical Industry', 'Safe, dense, and traceable warehouse automation for palletized chemicals and production materials.\nKey Challenges: hazardous material handling, inventory accuracy, throughput pressure, traceability requirements\nTypical Solutions: Shuttle ASRS, stacker crane systems, WMS integration, automated conveyors', 'case-studies.html?industry=chemical-petrochemical#caseGrid', '', 'Chemical'),
                        cardItem('industry-food', 'Food & Beverage', 'Clean, reliable automation for food storage, packaging lines, and high-frequency logistics centers.\nTypical Solutions: ASRS, conveyors, AGV transfer, pallet handling', 'case-studies.html?industry=food-beverage#caseGrid', '', 'Food & Beverage'),
                        cardItem('industry-packaging', 'Packaging & Converting', 'Automation solutions for packaging, bag making, filling, film blowing, converting, and finished goods storage.\nTypical Solutions: production line automation, conveyors, AGV logistics, packaging systems', 'case-studies.html?industry=packaging-printing#caseGrid', '', 'Packaging & Converting'),
                        cardItem('industry-cold', 'Cold Storage', 'Automated cold warehouses reduce manual exposure and improve storage density in low-temperature environments.\nTypical Solutions: cold storage ASRS, stacker crane, shuttle, WMS', 'case-studies.html?industry=cold-chain-frozen-food#caseGrid', '', 'Cold Storage'),
                        cardItem('industry-pharma', 'Pharmaceutical', 'Traceable and controlled storage systems for pharmaceutical materials and finished goods.\nTypical Solutions: ASRS, WMS, controlled handling, validated workflows', 'case-studies.html?industry=pharmaceutical-biotech#caseGrid', '', 'Pharmaceutical'),
                        cardItem('industry-printing', 'Printing Industry', 'Automation solutions for printing, converting, flexible packaging, and production material handling.\nRelated Technologies: printing equipment, AGV, conveyors, WMS, ASRS', 'case-studies.html?industry=packaging-printing&solution=printing-inkjet-flexo-ci#caseGrid', '', 'Printing'),
                        cardItem('industry-manufacturing', 'Industrial Manufacturing', 'Smart factory upgrades for material flow, robotic handling, and multi-machine coordination.\nTypical Solutions: AGV logistics, automated lines, robotic automation', 'case-studies.html?industry=manufacturing-industrial#caseGrid', '', 'Industrial Manufacturing'),
                        cardItem('industry-logistics', 'Logistics & Distribution', 'High-throughput automation for fulfillment centers, order waves, and dense storage operations.\nTypical Solutions: shuttle ASRS, conveyor sorting, WES, AGV transfer', 'case-studies.html?industry=logistics-distribution#caseGrid', '', 'Logistics & Distribution'),
                        cardItem('industry-electronics', 'Electronics Manufacturing', 'Material flow, line feeding, and storage automation for electronics production environments.', 'case-studies.html?industry=electronics-semiconductors#caseGrid', '', 'Electronics'),
                        cardItem('industry-automotive', 'Automotive Manufacturing', 'Automation for line-side logistics, parts storage, production handling, and factory upgrades.', 'case-studies.html?industry=automotive-transportation#caseGrid', '', 'Automotive'),
                        cardItem('industry-building-materials', 'Building Materials', 'Storage, handling, and production automation for heavy, bulky, or high-volume industrial materials.\nTypical Solutions: conveyors, AGV, pallet handling, warehouse automation', 'case-studies.html?solution=material-pallet-handling#caseGrid', '', 'Building Materials'),
                    ],
                },
                {
                    id: 'industries-tech',
                    ...
                    text: '',
                    items: [
                        cardItem('tech-asrs', 'ASRS Systems', '', 'case-studies.html?solution=asrs#caseGrid'),
                        cardItem('tech-shuttle', 'Shuttle Systems', '', 'case-studies.html?solution=asrs#caseGrid'),
                        cardItem('tech-stacker', 'Stacker Crane Systems', '', 'case-studies.html?solution=asrs#caseGrid'),
                        cardItem('tech-agv', 'AGV & AMR', '', 'case-studies.html?solution=conveyor-transport#caseGrid'),
                        cardItem('tech-smart-factory', 'Smart Factory Automation', '', 'case-studies.html?solution=smart-factory#caseGrid'),
                        cardItem('tech-printing', 'Printing & Packaging', '', 'case-studies.html?industry=packaging-printing#caseGrid'),
                        cardItem('tech-filling', 'Filling Systems', '', 'case-studies.html?solution=filling-bottling#caseGrid'),
                        cardItem('tech-film', 'Film Blowing', '', 'case-studies.html?solution=film-blowing-extrusion#caseGrid'),
                        cardItem('tech-laser', 'Laser Processing', '', 'case-studies.html?solution=laser-industrial-machining#caseGrid'),
                    ],
                },
                {
                    id: 'industries-cta',
        ...
        return [
            ...
            },
            {
                ...
                ctaHref: '',
                items: [
                    { id: 'solutions-factory-production', title: 'Production Line Automation', text: 'Improve production efficiency and process consistency through integrated manufacturing systems.', href: 'case-studies.html?solution=production-line#caseGrid', image: 'solutions-production-line.webp', alt: 'Production line automation' },
                    { id: 'solutions-factory-robotic', title: 'Robotic Handling & Automation', text: 'Reduce repetitive labor and increase operational stability.', href: 'case-studies.html?solution=robotics-integration#caseGrid', image: 'solutions-robotic-handling.webp', alt: 'Robotic handling and automation' },
                    { id: 'solutions-factory-flow', title: 'Material Flow & Logistics', text: 'Connect production processes through intelligent transportation and line-feeding systems.', href: 'case-studies.html?solution=conveyor-transport#caseGrid', image: 'solutions-material-flow.webp', alt: 'Material flow and logistics automation' },
                    { id: 'solutions-factory-upgrade', title: 'Factory Upgrade Programs', text: 'Implement automation step by step without disrupting existing operations.', href: 'case-studies.html?solution=smart-factory#caseGrid', image: 'solutions-factory-upgrade.webp', alt: 'Factory upgrade automation program' },
                ],
            },
            {
            ...
            },
            {
                ...
                ctaHref: '',
                items: [
                    { id: 'solutions-machinery-printing', title: 'Printing & Packaging Systems', text: 'Printing, converting, packaging, and bag-making technologies for flexible packaging and industrial production.', href: 'case-studies.html?industry=packaging-printing&solution=printing-inkjet-flexo-ci#caseGrid', image: '', alt: '' },
                    { id: 'solutions-machinery-filling', title: 'Filling & Film Blowing Systems', text: 'Filling lines, film extrusion equipment, and integrated packaging production solutions.', href: 'case-studies.html?industry=packaging-printing&solution=film-blowing-extrusion#caseGrid', image: '', alt: '' },
                    { id: 'solutions-machinery-laser', title: 'Laser Processing & Industrial Equipment', text: 'Laser cutting, laser processing, and advanced manufacturing equipment for industrial applications.', href: 'case-studies.html?solution=laser-industrial-machining#caseGrid', image: '', alt: '' },
                ],
            },
            {
                id: 'solutions-proof',
