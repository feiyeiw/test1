    ...
    function getDefaultPageModules(page) {
        if (page === 'home') {
            return [
                pageHero('home-hero', 'Hero / Home intro', '13ASRS Industrial Automation', 'Industrial Automation Solutions for Warehouses and Factories', 'Warehouse automation, smart factory systems, packaging technologies, and industrial manufacturing solutions designed to improve efficiency, productivity, and operational performance.'),
                {
                    ...
                    items: [
                        cardItem('home-core-asrs', 'ASRS & Smart Warehouse Solutions', 'Shuttle ASRS, stacker crane, miniload, cold storage, conveyors, WMS/WES, and AGV logistics.', '/case-studies?solution=asrs#caseGrid'),
                        cardItem('home-core-factory', 'Smart Factory Automation', 'Automated production lines, robotic automation, intelligent material handling, factory upgrades, and multi-machine systems.', '/case-studies?industry=manufacturing-industrial&solution=conveyor-transport#caseGrid'),
                        cardItem('home-core-machinery', 'Industrial Machinery Solutions', 'Printing, packaging, filling, film blowing, bag making, laser equipment, and supporting manufacturing systems.', '/case-studies?industry=manufacturing-industrial#caseGrid'),
                    ],
                },
                {
                    ...
                    items: [
                        cardItem('home-case-chemical', 'Shuttle ASRS Warehouse for Chemical Industry', 'Height: 18m\nCapacity: +300%\nThroughput: +60%\nLabor: Reduced', '/case-studies?industry=chemical-petrochemical&solution=asrs#caseGrid'),
                        cardItem('home-case-pharma', 'Stacker Crane ASRS for Pharmaceutical Storage', 'System: Crane ASRS\nTraceability: WMS\nQuality: Controlled\nOperation: 24/7', '/case-studies?industry=pharmaceutical-biotech&solution=asrs#caseGrid'),
                        cardItem('home-case-agv', 'AGV Logistics for Smart Factory Material Flow', 'AGV: Multi-route\nLine Feed: Automated\nSafety: Improved\nHandling: Reduced', '/case-studies?industry=manufacturing-industrial&solution=conveyor-transport#caseGrid'),
                    ],
                },
                {
                    id: 'home-process',
        ...
        if (page === 'industries') {
            return [
                pageHero('industries-hero', 'Hero / Industries intro', 'Industries', 'Automation Solutions Designed Around Real Operational Challenges.', 'Explore how manufacturers, warehouses, and logistics operators improve storage capacity, production efficiency, material flow, and operational performance through practical automation technologies.'),
                {
                    ...
                    text: '',
                    items: [
                        cardItem('industries-proof-1', '10+ Industries', '', '/case-studies#caseGrid'),
                        cardItem('industries-proof-2', '100+ Project References', '', '/case-studies#caseGrid'),
                        cardItem('industries-proof-3', 'Warehouse Automation', '', '/case-studies?solution=asrs#caseGrid'),
                        cardItem('industries-proof-4', 'Smart Factory Solutions', '', '/case-studies?solution=smart-factory#caseGrid'),
                        cardItem('industries-proof-5', 'Industrial Manufacturing Systems', '', '/case-studies?industry=manufacturing-industrial#caseGrid'),
                    ],
                },
                {
                    id: 'industries-list',
                    ...
                    text: '',
                    items: [
                        cardItem('industry-chemical', 'Chemical Industry', 'Safe, dense, and traceable warehouse automation for palletized chemicals and production materials.\nKey Challenges: hazardous material handling, inventory accuracy, throughput pressure, traceability requirements\nTypical Solutions: Shuttle ASRS, stacker crane systems, WMS integration, automated conveyors', '/case-studies?industry=chemical-petrochemical#caseGrid', '', 'Chemical'),
                        cardItem('industry-food', 'Food & Beverage', 'Clean, reliable automation for food storage, packaging lines, and high-frequency logistics centers.\nTypical Solutions: ASRS, conveyors, AGV transfer, pallet handling', '/case-studies?industry=food-beverage#caseGrid', '', 'Food & Beverage'),
                        cardItem('industry-packaging', 'Packaging & Converting', 'Automation solutions for packaging, bag making, filling, film blowing, converting, and finished goods storage.\nTypical Solutions: production line automation, conveyors, AGV logistics, packaging systems', '/case-studies?industry=packaging-printing#caseGrid', '', 'Packaging & Converting'),
                        cardItem('industry-cold', 'Cold Storage', 'Automated cold warehouses reduce manual exposure and improve storage density in low-temperature environments.\nTypical Solutions: cold storage ASRS, stacker crane, shuttle, WMS', '/case-studies?industry=cold-chain-frozen-food#caseGrid', '', 'Cold Storage'),
                        cardItem('industry-pharma', 'Pharmaceutical', 'Traceable and controlled storage systems for pharmaceutical materials and finished goods.\nTypical Solutions: ASRS, WMS, controlled handling, validated workflows', '/case-studies?industry=pharmaceutical-biotech#caseGrid', '', 'Pharmaceutical'),
                        cardItem('industry-printing', 'Printing Industry', 'Automation solutions for printing, converting, flexible packaging, and production material handling.\nRelated Technologies: printing equipment, AGV, conveyors, WMS, ASRS', '/case-studies?industry=packaging-printing&solution=printing-inkjet-flexo-ci#caseGrid', '', 'Printing'),
                        cardItem('industry-manufacturing', 'Industrial Manufacturing', 'Smart factory upgrades for material flow, robotic handling, and multi-machine coordination.\nTypical Solutions: AGV logistics, automated lines, robotic automation', '/case-studies?industry=manufacturing-industrial#caseGrid', '', 'Industrial Manufacturing'),
                        cardItem('industry-logistics', 'Logistics & Distribution', 'High-throughput automation for fulfillment centers, order waves, and dense storage operations.\nTypical Solutions: shuttle ASRS, conveyor sorting, WES, AGV transfer', '/case-studies?industry=logistics-distribution#caseGrid', '', 'Logistics & Distribution'),
                        cardItem('industry-electronics', 'Electronics Manufacturing', 'Material flow, line feeding, and storage automation for electronics production environments.', '/case-studies?industry=electronics-semiconductors#caseGrid', '', 'Electronics'),
                        cardItem('industry-automotive', 'Automotive Manufacturing', 'Automation for line-side logistics, parts storage, production handling, and factory upgrades.', '/case-studies?industry=automotive-transportation#caseGrid', '', 'Automotive'),
                        cardItem('industry-building-materials', 'Building Materials', 'Storage, handling, and production automation for heavy, bulky, or high-volume industrial materials.\nTypical Solutions: conveyors, AGV, pallet handling, warehouse automation', '/case-studies?solution=material-pallet-handling#caseGrid', '', 'Building Materials'),
                    ],
                },
                {
                    id: 'industries-tech',
                    ...
                    text: '',
                    items: [
                        cardItem('tech-asrs', 'ASRS Systems', '', '/case-studies?solution=asrs#caseGrid'),
                        cardItem('tech-shuttle', 'Shuttle Systems', '', '/case-studies?solution=asrs#caseGrid'),
                        cardItem('tech-stacker', 'Stacker Crane Systems', '', '/case-studies?solution=asrs#caseGrid'),
                        cardItem('tech-agv', 'AGV & AMR', '', '/case-studies?solution=conveyor-transport#caseGrid'),
                        cardItem('tech-smart-factory', 'Smart Factory Automation', '', '/case-studies?solution=smart-factory#caseGrid'),
                        cardItem('tech-printing', 'Printing & Packaging', '', '/case-studies?industry=packaging-printing#caseGrid'),
                        cardItem('tech-filling', 'Filling Systems', '', '/case-studies?solution=filling-bottling#caseGrid'),
                        cardItem('tech-film', 'Film Blowing', '', '/case-studies?solution=film-blowing-extrusion#caseGrid'),
                        cardItem('tech-laser', 'Laser Processing', '', '/case-studies?solution=laser-industrial-machining#caseGrid'),
                    ],
                },
                {
                    id: 'industries-cta',
        ...
        return [
            ...
            },
            {
                ...
                ctaHref: '',
                items: [
                    { id: 'solutions-factory-production', title: 'Production Line Automation', text: 'Improve production efficiency and process consistency through integrated manufacturing systems.', href: '/case-studies#caseGrid', image: 'solutions-production-line.webp', alt: 'Production line automation' },
                    { id: 'solutions-factory-robotic', title: 'Robotic Handling & Automation', text: 'Reduce repetitive labor and increase operational stability.', href: '/case-studies?solution=robotics-integration#caseGrid', image: 'solutions-robotic-handling.webp', alt: 'Robotic handling and automation' },
                    { id: 'solutions-factory-flow', title: 'Material Flow & Logistics', text: 'Connect production processes through intelligent transportation and line-feeding systems.', href: '/case-studies?solution=conveyor-transport#caseGrid', image: 'solutions-material-flow.webp', alt: 'Material flow and logistics automation' },
                    { id: 'solutions-factory-upgrade', title: 'Factory Upgrade Programs', text: 'Implement automation step by step without disrupting existing operations.', href: '/case-studies?solution=smart-factory#caseGrid', image: 'solutions-factory-upgrade.webp', alt: 'Factory upgrade automation program' },
                ],
            },
            {
            ...
            },
            {
                ...
                ctaHref: '',
                items: [
                    { id: 'solutions-machinery-printing', title: 'Printing & Packaging Systems', text: 'Printing, converting, packaging, and bag-making technologies for flexible packaging and industrial production.', href: '/case-studies?industry=packaging-printing&solution=printing-inkjet-flexo-ci#caseGrid', image: '', alt: '' },
                    { id: 'solutions-machinery-filling', title: 'Filling & Film Blowing Systems', text: 'Filling lines, film extrusion equipment, and integrated packaging production solutions.', href: '/case-studies?industry=packaging-printing&solution=film-blowing-extrusion#caseGrid', image: '', alt: '' },
                    { id: 'solutions-machinery-laser', title: 'Laser Processing & Industrial Equipment', text: 'Laser cutting, laser processing, and advanced manufacturing equipment for industrial applications.', href: '/case-studies?solution=laser-industrial-machining#caseGrid', image: '', alt: '' },
                ],
            },
            {
                id: 'solutions-proof',
